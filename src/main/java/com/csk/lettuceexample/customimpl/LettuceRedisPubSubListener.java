package com.csk.lettuceexample.customimpl;
...
public class LettuceRedisPubSubListener implements RedisPubSubListener<String, String> {
	...
	public LettuceRedisPubSubListener(String sessionId, String destination, 
